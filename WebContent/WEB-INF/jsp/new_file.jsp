	...
	<body>
			...
			<div class="row-fluid">
				...
				<div id="content" class="span10">
					...
					<div class="row">
						...
						<div class="col-md-9"><input type="text" placeholder="查找" class="input-sou" />
							<button>查询按钮</button>
							<button>增加用户按钮</button>
						</div>
					</div>
					<div class="row">
							...
							<table class="table table-bordered ">
								...
								<tbody>
									<tr>
										...
										<td>40.00</td>
										<th class="th-btn">
											<button class="addpay" onclick="addpay()">充值</button>
											<button class="del" onclick="disp_prompt()"></button>
											<button class="modify" onclick="del(this);"></button>
										</th>
									</tr>
									<tr>
										<td>用户1</td>
		...
		<script type="text/javascript">
			function disp_prompt() {
				var name = prompt("请输入您要修改的数据"); // 弹出input框    
			}

			function addpay() {
				var name = prompt("请输入您要充值的数据"); // 弹出input框    
			}
		</script>
